...
<%@page import="dto.WeeklyMeal"%>
<%@page import="utils.MealType"%>
...
<html>
    ...
    <body>
        ...
        <c:set var="weeklyMeal" value="${requestScope.weeklyMeal}"/>
        <c:set var="detail" value="${weeklyMeal.getMeals()}"/>
        <c:set var="msg" value="${requestScope.msg}"/>


        <div class="banner">
            <div class="banner-title">
                <span>${weeklyMeal.getName()}</span>
            </div>
        </div>
        <main>
            ...
            <form action="main" method="post">
                ...
                <div class="action-crud">
                    <button class="save" type="submit" name="route" value="customer-fetch-weekly-meal">
                        <span>ADD THIS TO YOUR OWN WEEKLY MEAL</span>
                    </button>
                </div>
            </form>
        </main>
