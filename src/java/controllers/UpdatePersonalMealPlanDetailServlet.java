 ...
 * @author hoang
 */
@WebServlet({"/personal-get-update-meal-plan-detail-view", "/personal-update-meal-plan-detail"})
public class UpdatePersonalMealPlanDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("edit-weekly-meal-detail-personal.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int personalMealId = Integer.parseInt(request.getParameter("personalMealId"));
        List<PersonalMealPlanDetail> personalList = new ArrayList<>();
        PersonalMealPlanDAO personalDao = PersonalMealPlanDAO.getInstance();
        PersonalMealPlanDetailDAO personalDetailDao = PersonalMealPlanDetailDAO.getInstance();
        Map<Days, Map<MealType, List<Meal>>> mealList = personalDao.initMealList();
            ...
            if (day.equals(Days.MONDAY)) {
                mapForADay.forEach((mealType, listForAType) -> {
                    listForAType.forEach(meal -> {
                        PersonalMealPlanDetail detail = new PersonalMealPlanDetail(personalMealId, meal, mealType, day.getValue());
                ...
                mapForADay.forEach((mealType, listForAType) -> {
                    listForAType.forEach(meal -> {
                        PersonalMealPlanDetail detail = new PersonalMealPlanDetail(personalMealId, meal, mealType, day.getValue());
                        PersonalMealPlanDetail addedDetail = personalList.stream()
...
//        String str = "";
//        for (PersonalMealPlanDetail detail : personalList) {
...
//        }
        ...
        response.sendRedirect("main?route=personal-get-meal-plan-detail&personalMealId=" + personalMealId);
    }
}
