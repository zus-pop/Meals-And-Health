 ...
 * @author hoang
 */
@WebServlet("/admin-add-weekly-meal-detail")
public class AdminAddWeeklyDetailServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<WeeklyMealDetail> weeklyDetailList = new ArrayList<>();
        ...
        mealList.forEach((day, mapForADay) -> {
            if (day.equals(Days.MONDAY)) {
                ...
                mapForADay.forEach((mealType, listForAType) -> {
                    listForAType.forEach(meal -> {
                        WeeklyMealDetail detail = new WeeklyMealDetail(weeklyId, meal, mealType, day.getValue());
                        WeeklyMealDetail addedDetail = weeklyDetailList.stream()
...
//        }
        int result = weeklyDetailDao.persist(weeklyDetailList);
