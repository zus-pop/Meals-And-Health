        ...
        <main>
            ...
            <form action="main" method="post">
                ...
                <div class="action-crud">
                    <button value="admin-update-weekly-detail" name="route" class="update" type="submit">
                        Update
                    </button>
                    <a class="cancel" href="main?route=admin-get-weekly-detail&weeklyId=${weeklyMeal.getId()}">
                        <span>Cancel</span>
                    </a>
                </div>
            </form>
